class Context < ActiveRecord::Base
  ...
  has_many :notes
  belongs_to :user,            :foreign_key => :teacher_id, :conditions=> 'users.role="teacher"'
...
#  attr_accessor :teacher
  attr_accessible :name, :competence, :classroom, :teacher_id
  
  validates_presence_of :name, :competence_id, :classroom_id, :teacher_id
  validates_associated :competence, :classroom, :user
